                    ...
                    <div class="row">
                        <div class="col-lg-9 offset-lg-3">
                            <div class="main_slider" data-slick='{"arrows": false}'>
                                <div class="slider_item set-bg-image" data-background="{{ asset('frontendapp/images/slider/slide-2.jpg') }}">
                                ...
                                <div class="slider_item set-bg-image" data-background="{{ asset('frontendapp/images/slider/slide-3.jpg') }}">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                                ...
                                <div class="slider_item set-bg-image" data-background="{{ asset('frontendapp/images/slider/slide-1.jpg') }}">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                                ...
                                <div class="product-area clearfix">
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontendapp/images/shop/product_img_12.png') }}" alt>
                                            <div class="actions">
                                                <ul>
                                                    <li>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontendapp/images/shop/product-img-21.png') }}" alt>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontendapp/images/shop/product-img-22.png') }}" alt>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontendapp/images/shop/product-img-23.png') }}" alt>
                                            <span class="theme-badge">Sale</span>
                                            <div class="actions">
                                                <ul>
                                                    <li>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontendapp/images/shop/product-img-24.png') }}" alt>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontendapp/images/shop/product-img-25.png') }}" alt>
                                            <div class="actions">
                                                <ul>
                                                    <li>
                                                        <a href="#"><svg role="img" xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" viewBox="0 0 24 24" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Favourite</title> <path d="M12,21 L10.55,19.7051771 C5.4,15.1242507 2,12.1029973 2,8.39509537 C2,5.37384196 4.42,3 7.5,3 C9.24,3 10.91,3.79455041 12,5.05013624 C13.09,3.79455041 14.76,3 16.5,3 C19.58,3 22,5.37384196 22,8.39509537 C22,12.1029973 18.6,15.1242507 13.45,19.7149864 L12,21 Z"/> </svg></a>
                                ...
                                <div class="top_category_carousel2" data-slick='{"dots": false}'>
                                        ...
                                        <div class="category_boxed">
                                            <a href="#!">
                                                  <span class="item_image">
                                                      <img src="{{ asset('frontendapp/images/categories/category_1.png') }}" alt="image_not_found">
                                                  </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{ asset('frontendapp/images/categories/category_2.png') }}" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{ asset('frontendapp/images/categories/category_3.png') }}" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{ asset('frontendapp/images/categories/category_4.png') }}" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{ asset('frontendapp/images/categories/category_5.png') }}" alt="image_not_found">
                                                </span>
                            ...
                            <div class="product-sidebar">
                                <div class="widget latest_product_carousel">
                                    ...
                                    <div class="vertical_slider_4item" data-slick='{"dots": false}'>
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset('frontendapp/images/latest_product/latest_product_1.png') }}" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                        ...
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset('frontendapp/images/latest_product/latest_product_2.png') }}" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                                        <a href="shop_details.html">Product Sample</a>
                                        ...
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset('frontendapp/images/latest_product/latest_product_3.png') }}" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                                        <a href="shop_details.html">Product Sample</a>
                                        ...
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset('frontendapp/images/latest_product/latest_product_4.png') }}" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                                        <a href="shop_details.html">Product Sample</a>
                                ...
                                <div class="widget product-add">
                                    <div class="product-img">
                                        <img src="{{ asset('frontendapp/images/shop/product_img_10.png') }}" alt>
                                    </div>
                                    <div class="details">
                                        <h4>iPad pro</h4>
                ...
                <div class="container">
                    <div class="row promotion_banner_wrap">
                        <div class="col col-lg-6">
                            <div class="promotion_banner">
                                <div class="item_image">
                                    <img src="{{ asset('frontendapp/images/promotion/banner_img_1.png') }}" alt>
                                </div>
                                <div class="item_content">
                        ...
                        <div class="col col-lg-6">
                            <div class="promotion_banner">
                                <div class="item_image">
                                    <img src="{{ asset('frontendapp/images/promotion/banner_img_2.png') }}" alt>
                                </div>
                                <div class="item_content">
                    ...
                    <div class="row newarrivals_products">
                        ...
                        <div class="col col-lg-7">
                            <div class="new-arrivals-grids clearfix">
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('frontendapp/images/shop/product-img-28.png') }}" alt>
                                        <div class="actions">
                                            <ul>
                                                <li>
                                                    <a href="#"><svg role="img" xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" viewBox="0 0 24 24" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Favourite</title> <path d="M12,21 L10.55,19.7051771 C5.4,15.1242507 2,12.1029973 2,8.39509537 C2,5.37384196 4.42,3 7.5,3 C9.24,3 10.91,3.79455041 12,5.05013624 C13.09,3.79455041 14.76,3 16.5,3 C19.58,3 22,5.37384196 22,8.39509537 C22,12.1029973 18.6,15.1242507 13.45,19.7149864 L12,21 Z"/> </svg></a>
                                ...
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('frontendapp/images/shop/product-img-26.png') }}" alt>
                                ...
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('frontendapp/images/shop/product-img-27.png') }}" alt>
                    ...
                    <div class="brand_carousel">
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{ asset('frontendapp/images/brand/brand_1.png') }}" alt="image_not_found">
                                <img src="{{ asset('frontendapp/images/brand/brand_1.png') }}" alt="image_not_found">
                            </a>
                        </div>
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{ asset('frontendapp/images/brand/brand_2.png') }}" alt="image_not_found">
                                <img src="{{ asset('frontendapp/images/brand/brand_2.png') }}" alt="image_not_found">
                            </a>
                        </div>
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{ asset('frontendapp/images/brand/brand_3.png') }}" alt="image_not_found">
                                <img src="{{ asset('frontendapp/images/brand/brand_3.png') }}" alt="image_not_found">
                            </a>
                        </div>
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{ asset('frontendapp/images/brand/brand_4.png') }}" alt="image_not_found">
                                <img src="{{ asset('frontendapp/images/brand/brand_4.png') }}" alt="image_not_found">
                            </a>
                        </div>
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{ asset('frontendapp/images/brand/brand_5.png') }}" alt="image_not_found">
                                <img src="{{ asset('frontendapp/images/brand/brand_5.png') }}" alt="image_not_found">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontendapp/images/viewed_products/viewed_product_img_1.png') }}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontendapp/images/viewed_products/viewed_product_img_2.png') }}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontendapp/images/viewed_products/viewed_product_img_3.png') }}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontendapp/images/viewed_products/viewed_product_img_4.png') }}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontendapp/images/viewed_products/viewed_product_img_5.png') }}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontendapp/images/viewed_products/viewed_product_img_6.png') }}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
