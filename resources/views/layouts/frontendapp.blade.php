...
<head>
    ...
    <title>Stowaa</title>
    <link rel="shortcut icon" href="{{ asset('frontendapp/images/logo/favourite_icon_1.png') }}">

    <!-- fraimwork - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/bootstrap.min.css') }}">

    <!-- icon font - css include -->   
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/fontawesome.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/stroke-gap-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/icofont.css') }}">

    <!-- animation - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/animate.css') }}">

    <!-- carousel - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/slick.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/slick-theme.css') }}">

    <!-- popup - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/magnific-popup.css') }}">

    <!-- jquery-ui - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/jquery-ui.css') }}">

    <!-- select option - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/nice-select.css') }}">

    <!-- woocommercen - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/woocommerce.css') }}">

    <!-- custom - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendapp/css/style.css') }}">
</head>
<body>
    ...
    <div class="body_wrap">
                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        <div class="flug_wrap">
                                            <img src="{{ asset('frontendapp/images/flug/flug_uk.png') }}" alt="image_not_found">
                                        </div>
                                        <select>
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="{{ asset('frontendapp/images/logo/logo_1x.png') }}" srcset="assets/images/logo/logo_2x.png 2x" alt>
                                </a>
                            </div>
                        </div>
        ...
        <!-- sidebar cart - start
                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('frontendapp/images/cart/cart_img_1.jpg') }}" alt="image_not_found">
                            </div>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('frontendapp/images/cart/cart_img_2.jpg') }}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('frontendapp/images/cart/cart_img_3.jpg') }}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
            ...
            {{-- connect to fortend page::  @yield('content') :: --}}
                @yield('content') 
                    ...
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="{{ asset('frontendapp/images/logo/logo_1x.png') }}" srcset="assets/images/logo/logo_2x.png') }} 2x" alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img src="{{ asset('frontendapp/images/app_store.png') }}" alt="app_store"></a></li>
                                    <li><a href="#!"><img src="{{ asset('frontendapp/images/play_store.png') }}" alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="{{ asset('frontendapp/images/payments_icon.png') }}" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('frontendapp/js/jquery.min.js') }}"></script>
    <script src="{{ asset('frontendapp/js/popper.min.js') }}"></script>
    <script src="{{ asset('frontendapp/js/bootstrap.min.js') }}"></script>

    <!-- carousel - jquery plugins collection -->
    <script src="{{ asset('frontendapp/js/jquery-plugins-collection.js') }}"></script>

    <!-- google map  -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
    <script src="{{ asset('frontendapp/js/gmaps.min.js') }}"></script>

    <!-- custom - main-js -->
    <script src="{{ asset('frontendapp/js/main.js') }}"></script>
